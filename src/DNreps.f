      subroutine dnreps(des,lddes,nobs,dim,s,lds,ncov1,ncov2,c1,wt,
     * order,
     * nuobs,xrep,job,info)
      integer lddes,nobs,dim,lds,ncov1,ncov2,order(nobs),nuobs,
     * xrep(nobs),info,job
      double precision des(lddes,dim),s(lds,*),c1(*),wt(nobs)
c
...
c
c
c $Header: /usr/local/cvsroot/funfits/src/DNreps.f,v 1.1.1.1 1998/05/24 21:50:07 agebhard Exp $
c
