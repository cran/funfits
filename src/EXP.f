...
c**** Exponential or Gaussian  type covariance
c**** K_ij= exp(-( sum_k( ||x1_ik- x2_jk||)*par(1)) )
C**** 
C*** in the code k is really ic
c
       subroutine expbs( nd,x1,n1, x2,n2, par, k)
...
c** pth power differences
               ...
               k(i,j)=  (abs(x1(i,ic)- xtemp))**2 + k(i,j)
 15             continue
 10    continue
 5      continue
