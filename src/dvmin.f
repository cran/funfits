...
c	Gcvpack - dvl
c
c $Header: /usr/local/cvsroot/funfits/src/dvmin.f,v 1.1.1.1 1998/05/24 21:50:08 agebhard Exp $
c
...
c			do grid search
	 ...
	 do 20 j = 1, ntbl
	    ...
	    tbl(j,2) = dvl(tbl(j,1),svals,z,npsing)
            tbl(j,3)= dtrace(tbl(j,1),svals,npsing)
 1000        format( 5e15.8)
